...
export function RichTextEditor({ value, onChange, placeholder = "Enter description..." }: RichTextEditorProps) {
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: `prose prose-sm dark:prose-invert max-w-none focus:outline-none min-h-[100px] p-3 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-900 ${
  ...
  return (
    <div className="space-y-2">
      <div className="flex gap-1 p-1 border border-zinc-300 dark:border-zinc-700 rounded-lg bg-zinc-50 dark:bg-zinc-800">
        <button
          type="button"
        ...
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M6 3a1 1 0 011-1h4.5a3.5 3.5 0 010 7H8v4a1 1 0 11-2 0V3zm2 2v3h3.5a1.5 1.5 0 100-3H8z" clipRule="evenodd" />
          </svg>
        </button>
        <button
          type="button"
